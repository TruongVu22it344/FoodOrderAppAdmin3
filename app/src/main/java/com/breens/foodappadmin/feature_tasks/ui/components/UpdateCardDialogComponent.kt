            ...
            LazyColumn(contentPadding = PaddingValues(12.dp)) {
                ...
                item{
                    ...
                    uiState.bitmap. let {bitmap->
                        if(bitmap!=null){
                            updateImageCard(bitmap, context as ComponentActivity){ success, imageUrl ->
                                if(success){
                                    imageUrl.let{
                                        uiState.imgUrl= it
                ...
                item {
                    ...
                    OutlinedTextField(
                        ...
                        label = { Text("Tên món") },
                        placeholder = { Text(card?.titleCard.toString() ?: "") },
                ...
                item {
                    ...
                    OutlinedTextField(
                        ...
                        label = { Text("Mô tả") },
                        placeholder = { Text(card?.bodyCard ?: "") },
                        colors = TextFieldDefaults.outlinedTextFieldColors(
                            focusedBorderColor = Color.Black,
                            unfocusedBorderColor = Color.Black,
                            focusedLabelColor = Color.Black,
                ...
                item {
                    ...
                    OutlinedTextField(
                        ...
                        label = { Text("Giá") },
                        placeholder = { Text("${card?.priceCard ?: 0}") },
                        colors = TextFieldDefaults.outlinedTextFieldColors(
                            focusedBorderColor = Color.Black,
                            unfocusedBorderColor = Color.Black,
                            focusedLabelColor = Color.Black,
...
fun updateImageCard(bitmap: Bitmap, context: ComponentActivity, calBack: (Boolean, String)->Unit) {
